...
const serviceData = {
  detox: { category: 'Коррекция тела', title: 'Детокс', prices: [['60 минут', '3 500 ₽'], ['90 минут', '5 200 ₽']], description: 'Лимфодренажная программа для визуальной коррекции проблемных зон, уменьшения отёчности и возвращения коже тонуса.', benefits: ['живот и бока', 'руки и бёдра', 'ощущение лёгкости'] },
  postpartum: { category: 'Коррекция тела', title: 'Послеродовое восстановление', prices: [['60 минут', '3 500 ₽']], description: 'Бережная программа для возвращения ощущения собранности, лёгкости и уверенности в своём теле после родов. Возможность проведения процедуры определяется индивидуально.', benefits: ['работа с отёчностью', 'тонус кожи', 'бережное восстановление'] },
  'ideal-body': { category: 'Коррекция тела', title: 'Идеальное тело', prices: [['60 минут', '3 500 ₽'], ['90 минут', '5 200 ₽']], description: 'Комбинированная работа с качеством кожи, отёчностью и контурами тела для более гладкого и подтянутого силуэта.', benefits: ['тонус и гладкость', 'контуры коленей', 'обменные процессы'] },
  glutes: { category: 'Коррекция тела', title: 'Упругие ягодицы', prices: [['60 минут', '3 500 ₽']], description: 'Направленная ручная работа с нижней частью тела: бёдрами, ягодицами и зоной над коленями.', benefits: ['визуальный лифтинг', 'более чёткий силуэт', 'тонус тканей'] },
  'flat-stomach': { category: 'Коррекция тела', title: 'Плоский живот', prices: [['60 минут', '3 500 ₽']], description: 'Специализированная ручная техника для зоны живота и боков, направленная на тонус, уменьшение отёчности и визуальную коррекцию объёмов.', benefits: ['живот и бока', 'упругость кожи', 'ощущение лёгкости'] },
  'stop-age': { category: 'Омоложение лица', title: 'СтопВозраст', prices: [['60 минут', '3 500 ₽']], description: 'Глубокая ручная работа с мышцами лица для более чёткого овала, свежего тона и естественного эффекта омоложения.', benefits: ['мышечный тонус', 'овал лица', 'здоровое сияние'] },
  'face-plastic': { category: 'Омоложение лица', title: 'Ручная пластика лица', prices: [['60 минут', '3 500 ₽']], description: 'Техника для укрепления мышц, уменьшения отёчности и повышения упругости кожи без инъекций и хирургического вмешательства.', benefits: ['более мягкие складки', 'чёткий контур', 'упругость кожи'] },
  lifting: { category: 'Косметология', title: 'Лифтинг-комплекс', prices: [['60 минут', '5 000 ₽']], description: 'Пять этапов ухода работают последовательно: очищение, мягкое отшелушивание, ручной массаж, фонофорез и альгинатная маска.', benefits: ['интенсивное увлажнение', 'тонус кожи', 'свежий цвет лица'] },
  cleaning: { category: 'Косметология', title: 'Механическая чистка', prices: [['105 минут', '3 600 ₽']], description: 'Классическая ручная процедура для глубокого очищения кожи и работы с закупоренными порами.', benefits: ['чёрные точки', 'расширенные поры', 'неровный рельеф'] },
  regeneration: { category: 'Косметология', title: 'Очищение + регенерация', prices: [['105 минут', '4 600 ₽']], description: 'Механическая чистка, алмазный пилинг и фонофорез в одной программе для чистой, гладкой и увлажнённой кожи.', benefits: ['глубокое очищение', 'обновление текстуры', 'восстановительный уход'] }
};
